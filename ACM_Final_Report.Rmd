...
The most significant variables from the above model are the intercept, `schoolMousinho da Silveira`, `failures`, `extra_school_supportTRUE`, `wants_higher_educationTRUE`. The intercept value is difficult to interpret considering the number of variables and types of variables involved in the model. The `schoolMousinho da Silveira` estimate of `-1.51318` suggests that, on average, Mousinho da Silveira had about `1.5` final grade points less than Gabriel Pereira.
