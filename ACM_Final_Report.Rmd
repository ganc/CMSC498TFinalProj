...
Other things to talk about are: how could we improve it (gather additional data, derive new features from existing data, using non-linear transformations, etc. etc.)
